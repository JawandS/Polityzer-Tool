...
JAVASCRIPT_DATABASE_FILE = os.path.join(DATABASE_FOLDER, "downloaded_javascript_links.csv")

# error logs settings
timestampFmt = "%Y-%m-%d-%H-%M-%S"
randomizer = datetime.datetime.now().strftime(timestampFmt)
ERROR_FILENAME = "".join(["error", randomizer, ".csv"])  # name of the error log file
